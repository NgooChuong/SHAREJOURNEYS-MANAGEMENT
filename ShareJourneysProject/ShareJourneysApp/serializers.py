...
class UserSerializer(serializers.ModelSerializer): # tra ve user
...
class PostSerializer(serializers.ModelSerializer): # 1 user n post
    ...
    class Meta:
        model = Posts
<<<<<<< HEAD
        fields = ["user","id", "created_date","title",'journey', "tags",'pic','avgRate','state']
=======
...
# class PostTagSerializer(PostSerializer):
#
#     class Meta:
...
class HistorySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = TravelCompanion
        fields = ['post_id', 'created_date', 'title', 'content','pic' ,'active']
...
class UserRouteSerializer(serializers.ModelSerializer):
    diaChiDon = LocalSerializer(source='id_Don')
    diaChiDen = LocalSerializer(source='id_Den')
    Companion = TravelCompanionSerializer(source='id_User')

    class Meta:
        model = UserRoute
        fields = ['diaChiDon', 'diaChiDen','Companion']
...
class ChangePasswordSerializer(serializers.Serializer):
    ...
    def validate_old_password(self, value):
        ...
        print('value',user.check_password(value))
